...
YES → Cybersäkerhetslagen applies, report to sector authority
...
- Legal basis: SFS 2025:1506, 1 kap 1 §, 4 §
...
- Report to: Sector supervisory authority
- Legal basis: SFS 2025:1506, 4 kap 6 §
...
DOCUMENT STRUCTURE
1. Introduction: Context and regulatory landscape
2. Analysis: Jurisdictional hierarchy and interaction mechanisms
3. Scope tables: Comparative application of each law
4. Incident definitions: Legal standards for reportable events
5. Reporting requirements: Timeframes and recipients
6. Decision flow: Three-question sequential model for classification
